...
func TestDefaultPolicyProfileDecisions(t *testing.T) {
	tests := []struct {
		...
		{name: "safe dev denies absolute path delete", profile: "safe-dev", actionType: "process.exec", resource: "file://workspace/", params: execParamsForTest("rm", "-rf", "/tmp/build"), want: DecisionDeny},
		{name: "safe dev denies parent delete", profile: "safe-dev", actionType: "process.exec", resource: "file://workspace/", params: execParamsForTest("rm", "-rf", "../other"), want: DecisionDeny},
		{name: "safe dev leaves workspace delete to default deny", profile: "safe-dev", actionType: "process.exec", resource: "file://workspace/", params: execParamsForTest("rm", "-rf", "build/"), want: DecisionDeny},
